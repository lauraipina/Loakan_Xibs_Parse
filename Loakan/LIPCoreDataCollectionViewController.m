...
@interface LIPCoreDataCollectionViewController ()<NSFetchedResultsControllerDelegate>
@property (strong, nonatomic) NSMutableArray *objectChanges;
@property (strong, nonatomic) NSMutableArray *sectionChanges;

@end

@implementation LIPCoreDataCollectionViewController
...
didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //UIViewController<LIPDetailViewController> *detailVC = [[NSClassFromString(self.detailViewControllerClassName) alloc] initWithModel:detailModel];
